import type { RedisCacheAdapter as RedisCacheAdapterType } from '@/infra/cache/redis-cache-adapter'
...
describe('RedisCacheAdapter', () => {
  ...
  beforeEach(async () => {
    ...
    const { RedisCacheAdapter } = await import('@/infra/cache/redis-cache-adapter')
