import { ViaCepAdapter } from '@/shared/infra/gateways/via-cep-adapter'
import { HttpClient, HttpRequest, HttpResponse } from '@/modules/geography/application/protocols/http/http-client'
